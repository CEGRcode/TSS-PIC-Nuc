...
## GET TATA box distance and TBP occupancy info

for file in TATA_TSS_same_5prime.bed; do
    filename=$(basename "$file" .bed)
...
for file in TATA_TSS_same_5prime_*.bed ; do
  ...
  java -jar $SCRIPTMANAGER coordinate-manipulation expand-bed -c 40 $file -o ${BED}_40bp.bed
  java -jar "$SCRIPTMANAGER" read-analysis tag-pileup ${BED}_40bp.bed $TBP --cpu 4 -1 -s 6 --combined -o TBP_${BED}_read1_combined_40bp.out
  java -jar "$SCRIPTMANAGER" read-analysis scale-matrix -r 1 -l 1 TBP_${BED}_read1_combined_40bp.out -s "$TBPFACTOR" -o TBP_${BED}_read1_combined_40bp_Normalized.out
  java -jar "$SCRIPTMANAGER" read-analysis tag-pileup ${BED}_40bp.bed $GTF2A --cpu 4 -1 -s 6 --combined -o GTF2A_${BED}_read1_combined_40bp.out
  java -jar "$SCRIPTMANAGER" read-analysis scale-matrix -r 1 -l 1 GTF2A_${BED}_read1_combined_40bp.out -s "$GTF2AFACTOR" -o GTF2A_${BED}_read1_combined_40bp_Normalized.out
  rm TBP_${BED}_read1_combined_40bp.out  
  rm GTF2A_${BED}_read1_combined_40bp.out
  rm ${BED}.bed ${BED}_40bp.bed
done
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-21_read1_combined_40bp_Normalized.out
16.7788
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-22_read1_combined_40bp_Normalized.out
26.0276
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-23_read1_combined_40bp_Normalized.out
42.4628
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-24_read1_combined_40bp_Normalized.out
69.1881
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-25_read1_combined_40bp_Normalized.out
58.6698
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-26_read1_combined_40bp_Normalized.out
72.2584
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-27_read1_combined_40bp_Normalized.out
68.7182
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-28_read1_combined_40bp_Normalized.out
65.109
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-29_read1_combined_40bp_Normalized.out
45.1329
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-30_read1_combined_40bp_Normalized.out
29.1987
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' TBP_TATA_TSS_same_5prime_-31_read1_combined_40bp_Normalized.out
19.4857


awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-21_read1_combined_40bp_Normalized.out
8.67114
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-22_read1_combined_40bp_Normalized.out
18.9739
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-23_read1_combined_40bp_Normalized.out
41.8517
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-24_read1_combined_40bp_Normalized.out
82.1432
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-25_read1_combined_40bp_Normalized.out
62.8917
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-26_read1_combined_40bp_Normalized.out
84.2187
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-27_read1_combined_40bp_Normalized.out
77.7337
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-28_read1_combined_40bp_Normalized.out
74.5891
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-29_read1_combined_40bp_Normalized.out
43.2167
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-30_read1_combined_40bp_Normalized.out
29.4898
awk 'NR == 2 {sum = 0; for(i = 1; i <= NF; i++) sum += $i} END {print sum}' GTF2A_TATA_TSS_same_5prime_-31_read1_combined_40bp_Normalized.out
9.02205
rm *_TATA_TSS_same_5prime_*_read1_combined_40bp_Normalized.out
