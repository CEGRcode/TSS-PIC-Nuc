...
# ───────────────────────────────────────────────
if len(sys.argv) != 2:
    print("Usage: python TFBS_Nuc.py <input_csv>")
    sys.exit(1)
...
plt.close()
print("✅ TF site count bar plot saved as: TF_M1_barplot_Nuc.png")
...
# ───────────────────────────────────────────────
output_dir_counts = "TFBS_phase_counts_Nuc"
...
print("✅ Saved:")
print("   TFBS_phase_skew_barplot_same_Nuc.png")
print("   TFBS_phase_skew_barplot_oppo_Nuc.png")
...
print("   → TFBS_phase_skew_ratios_Nuc.tsv")
