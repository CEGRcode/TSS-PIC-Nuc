...
with open(f"TF-Nuc_pie_charts/${TF}_${orientation}_pvalue.out", "w") as out_f:
...
ax.set(aspect="equal")
plt.tight_layout()
plt.savefig(f"TF-Nuc_pie_charts/${TF}_${orientation}_phase_pie.png", dpi=300, transparent=True)
